...
def process_sim_output(csvs_path, scenario):
    ...
    customer_log_stats = summarize_customer_log(customer_log_df, scenario)
...
def summarize_customer_log(customer_log_df, scenario):
    """
    ...
    performance_measures = ['wait_for_cart', 'wait_for_butcher', 'wait_for_cashier',
                            'time_in_system', 'time_in_system_peritem', 'cashier_speed']
...
def main():
    ...
    customer_log_stats = process_sim_output(output_dir, scenario)
    print(f"\nScenario: {scenario}")
